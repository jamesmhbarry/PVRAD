...
def confidence_band(axis,x,y,yerr,color=None,alpha = 0.3):
    """
    :param x:
    :param y:
    ...
    yerr = np.array(yerr)
    if color:
        axis.fill_between(x, y+ yerr, y - yerr, color=color, alpha=alpha)
    else:
        axis.fill_between(x, y+ yerr, y - yerr, alpha=alpha)
    return None
